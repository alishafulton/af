...
<div className="flex"><div className=" flex justify-center justify-items-center justify-self-center w-1/3 px-2 py-2 my-2 rounded-sm bg-black hover:bg-red-400 font-mono text-white text-xs tracking-tighter">
