...
<div className="flex w-full justify-items-center justify-center my-4">

<div className="flex flex-col mx-12 w-full h-96 justify-items-center justify-center">
<iframe 
...
<div className=" flex w-min px-2 bg-red-600 ">Open in a new window</div></a>
