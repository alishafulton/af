...
export default function Blurb() {
      ...
      return (
        <div className = "flex flex-col-reverse justify-center md:flex-row space-x-0 md:space-x-6 h-min ">
            <div className="w-40 md:w-52 "><Selfie/></div>
        
        <div className="w-64 md:w-96 text-2xs md:text-xs font-mono text-center md:text-left ">
