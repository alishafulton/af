...
export default function Blurb() {
      ...
      return (
        <div className = "flex flex-col justify-center justify-items-center md:flex-row space-x-0 md:space-x-6 mx-2 h-min ">
            <div className="flex w-full md:w-min justify-center "><Selfie/></div>
        
        <div className="w-full m-4 md:m-0 justify-center justify-items-center">
          <div className="w-96 text-2xs md:text-xs font-mono text-center md:text-left">
