  ...
  return (
    ...
    <div className="w-56 bg-purple float-left pr-4 pb-2 mr-2 mb-2"><img src={ wood } alt="" className="w-full ml-0"/></div>
      ...
      <div className="font-serif text-lg"> After spending a couple of weeks getting 
        ...
        <div className="w-58 bg-purple float-right pl-3 pb-4 ml-2 my-2 "><img src={ girls } alt="" className="w-full mr-0"/></div>
        ...
        <div className="w-54 bg-purple float-left pr-5 pb-2 mr-2 my-2"><img src={ pic5 } alt="" className="w-full ml-0"/></div>
        ...
        <div className="w-58 bg-purple float-right pl-2 pb-3 ml-4 my-2"><img src={ pic11 } alt="" className="w-full mr-0"/></div>
