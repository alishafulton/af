...
export default function Extra () {
    return (
      <div className="extras">
        ...
        <img src={ pic6 } alt="" className="pic"/>
        <img src={ pic7 } alt="" className="pic"/>
        <img src={ pic8 } alt="" className="pic"/>
        <img src={ pic9 } alt="" className="pic"/>
        <img src={ pic10 } alt="" className="pic"/>
        <img src={ pic11 } alt="" className="pic"/>
        <img src={ pic12 } alt="" className="pic"/>
        <img src={ pic13 } alt="" className="pic"/>
