  ...
  return (
    <div>
      ...
      <div className="flex-col w-full mt-2 px-3 py-5 ">
        ...
        <img src={ wood } alt="" className="w-2/5 float-left mr-2 bg-green border-r-6 border-purple "/>  
        ...
        <img src={ girls } alt="" className="w-5/12 float-right border-l-4 bg-green border-purple ml-2 mb-1"/>
        ...
        <img src={ pic5 } alt="" className="w-5/12 float-left border-r-4 bg-green border-purple  mr-2 mb-1"/>
        ...
        <br/> <img src={ pic11 } alt="" className="w-5/12 float-right border-l-4 bg-green border-purple  ml-2 mb-1"/>
        ...
        <img src={ pic10 } alt="" className="w-5/12 float-left border-r-4 bg-green border-purple mr-2 mb-1"/>
