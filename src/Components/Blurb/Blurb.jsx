    ...
    return (
      <div className='blurb'>
        ...
        <p>From learning to read at age three, to getting my Girl Scout Bronze, 
          ...
          <p><div className="intro">< AnotherIntro /></div> at a Starbucks in Santa Barbara, California, I 
        ...
        and learning an entire new group of people (both baristas and customers!)</p>

        <p><div className="intro">< ThirdIntro /></div>Spending over ten years in customer service has given me a keen ability 
