...
const Carousel = ({ children: slides, autoSlide = false, autoSlideInterval = 3000 }) => {
    ...
    return (
        <div className=' overflow-hidden flex  bg-transparent bg-orange'>
            <div className='flex-auto w-5/6 transition-transform ease-out duration-500 bg-blue' style={{ transform: `translateX(-${curr * 100}%)` }}>
                {slides}
            </div>
