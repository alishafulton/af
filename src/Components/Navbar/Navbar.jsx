...
export default function Navbar () {
  const activeLink = "text-purple";
    ...
    return (
      <div className="flex-col justify-center m-1">

        <div className="flex mt-3 w-full justify-center"><Logo/></div>

        
        <div className="justify-between w-full lg:w-2/3 font-sans text-3xl lg:text-5xl tracking-tighter text-black px-1 ">
