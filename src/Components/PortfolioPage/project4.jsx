...
export default function Project3() {
      ...
      return (
<div>
        <div className="w-44 md:w-56 justify-self-center border border-gray-200  group-hover:bg-blue group-hover:bg-opacity-10 group-hover:border-blue transition-all ease-in-out duration-300">
