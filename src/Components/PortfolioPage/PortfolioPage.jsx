...
export default function PortfolioPage() {
      ...
      return (
        <div className="w-full">
          ...
          <NavLink to="/coast/" className="blur backdrop-blur-none hover:bg-white hover:opacity-20 hover:backdrop-blur-[4px] hover:blur-lg duration-300 ease-in-out "><Project1 className="m-2 " /></NavLink>
