...
export default function PortfolioPage() {
      ...
      return (
        <div className="w-full justify-center justify-items-center">
          <div className="flex flex-row space-x-6 md:space-x-14 mx-2 md:mx-0 my-6 md:my-12  justify-center justify-items-center">
        ...
        <div className="flex flex-row space-x-6 md:space-x-14 my-6 md:my-12 justify-center justify-items-center">
