...
export default function PortfolioPage() {
      ...
      return (
        <div className="w-full">
          ...
          <NavLink to="/coast/" className={({ isActive }) => (isActive ? activeLink : "")}><Project1 className="m-2 backdrop-blur-none hover:bg-white hover:opacity-30 hover:backdrop-blur-lg " /></NavLink>
