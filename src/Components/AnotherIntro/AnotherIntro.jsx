...
export default function AnotherIntro () {
    return (
    <div className="intro"><div className="first-sentence">Working as a barista</div> at a Starbucks in Santa Barbara, California, I 
    ...
    and re-learning an entire new group of people (both baristas and customers!)</div>
    );
};