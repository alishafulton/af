...
export default function Text () {
    return (
        <div >
    <div className="font-sans text-2xl tracking-tighter">Hi, I'm Alisha!</div><div className="font-serif">
    ...
    <div className="font-serif">Spending over ten years in customer service has given me a keen ability 
    ...
    and allow me to create designs that will improve everyday user experiences.</div>
    </div>
